...
data:
  ...
  sshPublicKey: "$(cat ~/.ssh/isoboot_ed25519.pub)"
EOF
```
...
spec:
  ...
  responseTemplateRef: debian-ssh-key-v1
  configMaps:
    - config-01
EOF
```
...
9. Connect via SSH using the keypair you generated.
```
ssh -i ~/.ssh/isoboot_ed25519 isoboot@192.168.88.192
```
